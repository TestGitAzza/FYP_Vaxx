                        ...
                        <table id="datatable-buttons" class="table table-striped" style="width:100%">
                          ...
                          if (isset($_POST['check'])) {
                            if (empty($errors)) {
                              ...
                              $query2 = "SELECT * FROM doctor WHERE doc_id NOT IN 
                              (SELECT d.doc_id FROM appointment as a INNER JOIN doctor as d ON a.doc = d.doc_id 
                              ...
                              if ($num > 0) {    ?>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <form action="addappt.php?mykid=<?= $_GET['mykid'] ?>&id_appt=<?= $_GET['id_appt'] ?>&doc_id<?= $_GET['doc_id']?>" method="post">
                                  <td>
