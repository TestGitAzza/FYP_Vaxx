        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">   
                    <h2> Doctor's Appointment Scheduled </h2>                       
                  <div class="clearfix"></div>
                </div>
                <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <table id="datatable" class="table table-striped" style="width:100%">
                          ...
                          $query = "SELECT * from appointment where doc='$doc_id' and appt_status='Scheduled'";
                ...
                <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <table id="datatable" class="table table-striped" style="width:100%">
                          ...
                          $query = "SELECT * from appointment where doc='$doc_id' and appt_status='Completed'";
                          $result = mysqli_query($dbc, $query); // Run the query.
                          $num = mysqli_num_rows($result);
